...
Before going any further, check that the *NumPy* and *Matplotlib* libraries are installed in your _Python_ environment. If you are running under WSL (Windows System for Linux), you may also install *PyQt6*.
